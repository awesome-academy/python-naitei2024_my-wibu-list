...
urlpatterns = [
    ...
    path(
        "anime/<int:pk>", views.AnimeDetailView.as_view(), name="anime_detail"
    ),
    path(
        "manga/<int:pk>", views.MangaDetailView.as_view(), name="manga_detail"
    ),
    ...
    path(
        "edit_comment/<str:comment_id>", views.edit_comment, name="edit_comment"
    ),
    path(
    ...
    path(
        "product-detail/<int:pid>/", views.product_detail, name="product_detail"
    ),
